...
const navLinkClasses = ({ isActive }) =>
    isActive
        ? "btn btn-active btn-primary w-full justify-start"
        ...
        <aside className="w-64 bg-base-200 p-4 flex flex-col">
            ...
            <nav className="flex flex-col gap-2 ">
                ...
                <div className="collapse collapse-arrow bg-base-200">
                    <input type="checkbox" />
                    <div className="collapse-title font-medium">Manage Users</div>
                ...
                <div className="collapse collapse-arrow bg-base-200">
                    <input type="checkbox" />
                    <div className="collapse-title font-medium">AI & Data</div>
                    <div className="collapse-content flex flex-col gap-2 !p-0">
